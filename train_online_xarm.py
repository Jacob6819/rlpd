...
def main(_):
    ...
    exp_str = "firstTry"; use_gripper, use_camera, use_r3m, obs_key = False, True, True, "r3m_with_ppc"
    ...
    if "binary" in FLAGS.env_name:
        ...
        #TODO: THis is where the dataset is created. I don't know how it works but here is what we want to over ride
        ds = D4RLDataset(env)
